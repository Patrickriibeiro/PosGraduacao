...
public class CartaoServiceLocator extends org.apache.axis.client.Service implements com.patrickriibeiro.ws.CartaoService {
    ...
    private java.lang.String Cartao_address = "http://localhost:8081/CartaoWebService/services/Cartao";
    ...
    public com.patrickriibeiro.ws.Cartao getCartao(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.patrickriibeiro.ws.CartaoSoapBindingStub _stub = new com.patrickriibeiro.ws.CartaoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.patrickriibeiro.ws.Cartao.class.isAssignableFrom(serviceEndpointInterface)) {
                com.patrickriibeiro.ws.CartaoSoapBindingStub _stub = new com.patrickriibeiro.ws.CartaoSoapBindingStub(new java.net.URL(Cartao_address), this);
                _stub.setPortName(getCartaoWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.patrickriibeiro.com", "CartaoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.patrickriibeiro.com", "Cartao"));
        }
